...
$(function() {
    ...
    console.log('1. Skills sorted:', _.sortBy(_.uniq(_.flatten(_.map(data, 'skills')))));
    console.log('2. People sorted', _.sortBy(_.map(_.orderBy(data, 'friends.length'), 'name')));
    console.log('3. Friends sorted', _.uniq(_.map(_.flatten(_.map(data, 'friends')),'name')));
});
